...
export function StudentCardModal({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 print:hidden">
      {/* Modal Container */}
      <div className="bg-white rounded-2xl max-w-3xl w-full p-6 shadow-2xl relative flex flex-col md:flex-row gap-6 animate-scale-in border border-slate-100">
        
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 w-8 h-8 rounded-full flex items-center justify-center hover:bg-slate-100 transition-colors z-20"
        >
        ...
        <div className="flex flex-col items-center gap-4 shrink-0 mx-auto md:mx-0">
          ...
          <div
            className="w-[340px] h-[215px] card-perspective cursor-pointer"
