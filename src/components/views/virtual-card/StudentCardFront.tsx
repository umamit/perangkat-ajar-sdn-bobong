...
export function StudentCardFront({ s, selectedClassId }: any) {
  return (
    <div className="card-front rounded-[18px] overflow-hidden border border-teal-100 bg-gradient-to-br from-teal-50/60 via-slate-50 to-teal-50/30 text-slate-800 shadow-md flex flex-col justify-between p-0">
      ...
      <div className="flex justify-between items-end border-t border-slate-100 px-4 pb-3 pt-1.5 text-[6px] text-slate-500 font-bold bg-slate-50/50">
        ...
        <div className="text-right leading-none relative">
          ...
          <img src="/assets/ttd-stempel.png" alt="Stempel & TTD" className="absolute right-[-8px] bottom-[-4px] w-14 h-14 object-contain pointer-events-none z-10" />
